...
public class LikeController {
    ...
    public RestaurantResponse<LikeResponseDto> getLike(@RequestBody final LikeRequestDto likeRequestDto) {
        ...
        response = new RestaurantResponse(true, RestaurantConstant.ACTION_GET , RestaurantConstant.LIKE_ENTITY , likeResponseDto.getId());
        return response;
    }
    ...
    public RestaurantResponse<List<LikeResponseDto>> getLikes() {
        ...
        response = new RestaurantResponse(true, RestaurantConstant.ACTION_GET, RestaurantConstant.LIKE_ENTITY, likeResponseDtos.size() ,likeResponseDtos);
        return response;
    }
    ...
    public RestaurantResponse<List<LikeResponseDto>> getLikes(@PathVariable final Long id) {
        ...
        RestaurantResponse response = new RestaurantResponse(true, RestaurantConstant.ACTION_GET , RestaurantConstant.LIKE_ENTITY , null);
        return response;
    }
    ...
    public RestaurantResponse deleteLike(@RequestBody final LikeRequestDto likeRequestDto) {
        ...
        response = new RestaurantResponse(true, RestaurantConstant.ACTION_DELETE , RestaurantConstant.LIKE_ENTITY , null);
        return response;
    }
